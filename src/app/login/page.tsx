                ...
                <div className="bg-[#0a0a0a]/60 backdrop-blur-2xl border border-white/5 p-10 rounded-[2.5rem] shadow-2xl space-y-6">
                    <form onSubmit={handleLogin} className="space-y-5">
                        <div className="space-y-1.5">
                            <label className="text-[10px] font-black text-muted uppercase tracking-widest ml-4">Email</label>
                        ...
                        <div className="space-y-1.5">
                            <label className="text-[10px] font-black text-muted uppercase tracking-widest ml-4">Senha</label>
                            <div className="relative group">
                                <div className="absolute left-5 top-1/2 -translate-y-1/2 text-muted group-focus-within:text-primary transition-colors">
                        ...
                        {error && (
                            <p className="text-red-400 text-[10px] font-black uppercase tracking-widest text-center bg-red-500/5 py-2.5 rounded-xl border border-red-500/20">
                                {error}
                            </p>
                        )}
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full bg-primary text-white font-black uppercase tracking-[0.2em] text-xs py-5 rounded-2xl hover:opacity-90 hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-3 shadow-xl shadow-primary/20 group"
                        >
                    ...
                    <button
                        ...
                        className="w-full bg-white/5 border border-white/10 py-4 rounded-2xl hover:bg-white/10 active:scale-[0.98] transition-all flex items-center justify-center gap-3 text-sm"
                        style={{ color: '#ffffff' }}
                    >
                        ...
                        <span style={{ color: '#ffffff', fontWeight: 900 }}>Google</span>
                    </button>
